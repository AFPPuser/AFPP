...
class PPOMemory:
    ...
    def store_memory(self, episode_data: EpisodeData):
        ...
        skip_pulses = episode_data.skip_pulses.reshape(1, *episode_data.skip_pulses.shape)
        if self.skip_pulses is None:
            self.skip_pulses = skip_pulses
        else:
            self.skip_pulses = np.append(self.skip_pulses, skip_pulses, axis=0)
        ...
        if self.n_episodes > self.max_episodes:
            ...
            self.skip_pulses = self.skip_pulses[-self.max_episodes:]
